    ...
    return(
        <header className="w-full my-auto h-[50vh] flex flex-col justify-center">
            ...
            <div className="flex gap-8 text-neutral-500 items-center">
                <Link href={''} target="_blank" className=" underline underline-offset-2 hover:decoration-0 hover:text-black flex text-sm"><Instagram/></Link>
                <Link href={''} target="_blank" className=" underline underline-offset-2 hover:decoration-0 hover:text-black flex text-sm"><Twitter /></Link>
                <Link href={''} target="_blank" className=" underline underline-offset-2 hover:decoration-0 hover:text-black flex text-sm"><Linkedin /></Link>
